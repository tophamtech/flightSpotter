...
class Flight(object):
    ...
    def __str__(self):
        # Update return string here
        # template = "\"aircraft\":\"{}\",\"registration\":\"{}\",\"altitude\":\"{}\",\"ground_speed\":\"{}\",\"heading\":\"{}\",\"latitude\":\"{}\",\"longitude\":\"{}\"\""
        # tempTemplate = template.format(self.aircraft_code, self.registration, self.altitude, self.ground_speed, self.heading, self.latitude, self.longitude)
        # return "{"+tempTemplate+"}"
        return self
